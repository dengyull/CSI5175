...
import com.example.csi5175.backend.dao.OrderDao
...
class OrderControllerTest {
    ...
    fun setup() {
        ...
        l1.add(product1)
        val product2 = Product(pid = 34, mid = 2, image = null, pname = "watch", description = "good watch", category = "electronic", quantity = 20, price = 123.2, calories = null, label = null, sold = 0)
        l2.add(product2)
